...
2. **Train the model (optional)**:
   - If you want to optimize the model and apply pruning, run the following command:
     ...
     python pso.py
     ```
   - This will use Particle Swarm Optimization (PSO) to find the best hyperparameters and apply L1 pruning to the TinyBERT model, saving the optimized model in the `PSO+Pruning_saved_model/` folder.
